...
TEST(utilities_tests,
     get_random_unique_indexes_given_9_10_returns_set_with_size_9) {
  auto result_set = utilities::get_random_unique_indexes(9, 10);
  EXPECT_EQ(result_set.size(), 9);
}

// TEST(utilities_tests,
//     get_random_unique_indexes_given_10_10_returns_complete_set) {
...
TEST(utilities_tests,
     get_random_unique_indexes_given_0_10_returns_0_elements_in_set) {
...
// TEST(utilities_tests,
// get_random_unique_indexes_given_10_5_returns_0_elements_in_set) {
