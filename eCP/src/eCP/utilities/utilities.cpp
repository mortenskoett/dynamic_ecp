...
{
  assert (amount > -1 && "amount must be a positive number.");   // FIXME: Use NDEBUG to have asserts only in debug builds.
  assert (amount < container_size && "amount must be less than container_size");
