...
from ann_benchmarks.plotting.utils  import get_plot_label, compute_all_metrics, compute_metrics, create_linestyles, create_pointset
        ...
        for count in [10, 100]:
            for batch in [False, True]:
                ...
                for i, (properties, run) in enumerate(results):
                  results = compute_all_metrics(true_nn_distances, run, properties, args.recompute)
